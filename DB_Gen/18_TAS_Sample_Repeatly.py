...
def Sample(sample_size = 100, name = 'sampled_TAS_data.csv'):
    # 连接到数据库
    ...
    sampled_df = tag_df.groupby('Type', group_keys=False).apply(sample_data, n_samples= sample_size, include_groups= True)
